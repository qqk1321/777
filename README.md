	...
	<div id="mainDiv">
		<div id="content">
			<div id="code">
				...
				<span class="space"/><span class="comments">* 我们都是程序员,</span><br />
				<span class="space"/><span class="comments">* so I write some code to celebrate our 1st anniversary.</span><br />
				<span class="space"/><span class="comments">*/</span><br />
				Boy i = <span class="keyword">new</span> Boy(<span class="string">"老董伟"</span>);<br />
				Girl u = <span class="keyword">new</span> Girl(<span class="string">"刘珊珊"</span>);<br />
